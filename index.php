                        ...
                        <div class="row h-100">
                            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                <header class="entry-header">
                                    <h1>Global Aid</h1>
                                    <h4>Make the world a better place.</h4>
                                </header><!-- .entry-header -->

                               
                                <footer class="entry-footer d-flex flex-wrap align-items-center mt-5">
                                    <a href="causes.php" class="btn gradient-bg mr-2">Donate Now</a>
                                    <a href="login.php" class="btn orange-border">Log in</a>
                                </footer><!-- .entry-footer -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                    ...
                    <div class="items">
                        <div class="row h-100">
                            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                <header class="entry-header">
                                    <h1>Take part.</h1>
                                    <h4>Join and be part of our charity community</h4>
                                </header><!-- .entry-header -->
                    ...
                    <div class="items">
                        <div class="row h-100">
                            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                <header class="entry-header">
                                    <h1>Blessings</h1>
                                    <h4>The hand that gives shall always be Blessed</h4>
                                </header><!-- .entry-header -->
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box ">
                        ...
                        <div class="entry-content">
                            <p>Take part in various charity activities and lend a hand. Help others so that they can help others.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        ...
                        <header class="entry-header">
                            <h3 class="entry-title">Spread The Love</h3>
                        </header>

                        <div class="entry-content">
                            <p>Show some care and compassion for others. Make the world a better place by sharing. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        ...
                        <header class="entry-header">
                            <h3 class="entry-title">Financial Support</h3>
                        </header>

                        <div class="entry-content">
                            <p>Every donation goes towards towards buying food and medical supplies...etc among other charitable activities.</p>
                        </div>
                    </div>
                </div>
            </div><!-- .row -->
            ...
            <div class="row align-items-end">
                <div class="coL-12 col-lg-6">
                    <div class="section-heading">
                        <h2 class="entry-title">We love helping others, Join us today and be part of a beautiful community brought together by what we see as the 
						fabric of giving and love.</h2>
